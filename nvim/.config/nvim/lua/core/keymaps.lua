...
-- Press <leader>th to open a Horizontal terminal (bottom)
vim.keymap.set("n", "<leader>th", "<cmd>split | term<CR>", { desc = "Terminal Horizontal" })

-- Press <leader>tv to open a Vertical terminal (right side)
vim.keymap.set("n", "<leader>tv", "<cmd>vsplit | term<CR>", { desc = "Terminal Vertical" })
